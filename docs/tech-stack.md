...
- Container-relative positioning for accurate element placement
...
- Dynamic container adjustment for various screen sizes
- Automatic centering and alignment with underlying image
- Responsive info panels with intelligent edge detection
- Event-based communication between map elements
...
- `/js/components/` - UI components (CountdownTimer, AudioManager, InteractiveMap, etc.)
